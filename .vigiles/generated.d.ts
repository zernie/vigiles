...
declare module "vigiles/generated" {
  ...
  export type ProjectFile = 
    ...
    | "src/adapter-properties.test.ts"
    ...
    | "src/adapters/claude-code/dialect-drift.test.ts"
    ...
    | "src/adapters/claude-code/skill-reachability.test.ts"
    | "src/adapters/claude-code/skill-reachability.ts"
    ...
    | "src/adapters/codex/instruction-chain.test.ts"
    | "src/adapters/codex/instruction-chain.ts"
    ...
    | "src/adapters/opencode/instruction-chain.test.ts"
    | "src/adapters/opencode/instruction-chain.ts"
    ...
    | "src/hook-runtime-roots.test.ts"
    | "src/hook-runtime.ts"
