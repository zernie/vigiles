// 🔴 PUBLIC ENTRY POINT `vigiles` — every export here is a promise to users. The default for a
...
// be useful" is neither. Review point: the diff of `api-surface/vigiles.api.md`, which
